"""
1. 运行: `uv pip install openai ddgs newspaper4k lxml_html_clean agno sqlalchemy aiosqlite` 安装依赖
2. 运行: `python cookbook/db/async_sqlite/async_sqlite_for_team.py` 运行团队
"""
